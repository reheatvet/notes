...
Finally, for full transparency, here are the steps I went through to gather the data. 
Did I mess something up? Did I miss something? Please shout if something is incorrect!

**The full report sheet is available publically here:**
https://docs.google.com/spreadsheets/d/1ZBJEw1T2STyIPXeF45XQTTiUKayEWbgfs7sIsyS4bUc/edit?usp=sharing

1. I exported all veDelegate Voters from round 46
2. For all of these wallets, I scanned the incoming transactions for the latest transaction with the clause data of '0xeb71148c9B3cd57e228c2152d79f6e78F5F1ef9a' *(The veDelegate vote contract)*. This is the vote change date and the transaction ID (TX)
3. I gathered the better actions, latest reward, reward date from the veDelegate account and added those.
